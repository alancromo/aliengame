...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        icon = pygame.image.load('images/ship2.bmp')
    ...
    def _create_alien(self, alien_number, row_number):
            ...
            alien_width, alien_height = alien.rect.size
            alien.x = 40 / 2 + 1.2 * alien_width * alien_number
            alien.rect.x = alien.x
            alien.rect.y = 110 + 1.2 * alien.rect.height * row_number
    ...
    def _change_fleet_direction(self):
        ...
        self.settings.flett_direccion *= -1
